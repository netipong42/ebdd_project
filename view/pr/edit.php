                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control" id="inputPassword" name="docCreated" value="<?php echo $row_purchase['docCreated'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control" id="inputPassword" name="docWant" value="<?php echo $row_purchase['docWant'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control" id="inputPassword" name="docExe" value="<?php echo $row_purchase['docExe'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" id="inputPassword" name="credit" value="<?php echo $row_purchase['credit'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control" id="inputPassword" name="sendProduct" value="<?php echo $row_purchase['sendProduct'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody id="show_prodcut_select">
                                        <?php foreach ($row_detail as $key => $item) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control text-right qty" oninput='getValue(this)' name="qty[]" value="<?php echo $item['qty'] ?>" required>
                                                </td>
                                                <td>
                                                    <input type="number" class="form-control text-right discount" oninput='getValue(this)' name="discount[]" value="<?php echo $item['discount'] ?>" required>
                                                </td>
                                                <td><input type="number" class="form-control text-right total" name="total[]" value="<?php echo $item['total'] ?>" readonly> </td>
                                            </tr>
                                        <?php endforeach ?>
                                    </tbody>
                                    <tfoot>
