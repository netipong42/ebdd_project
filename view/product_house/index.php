                ...
                <div class="card-body">
                    <form id="formType">
                        <div class="form-group">
                            <label for="type_name">คลังสินค้า</label>
                            <input type="text" class="form-control" id="house_name" name="house_name" placeholder="คลังสินค้า..." required>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">แก้ไข คลังสินค้า</h5>
                ...
                <div class="modal-body">
                    <form id="formTypeEdit">
                        <div class="form-group">
                            <label for="type_name">คลังสินค้า</label>
                            <input type="text" class="form-control" id="house_name_edit" name="house_name" placeholder="คลังสินค้า..." required>
                            <input type="hidden" id="house_id_edit" name="house_id" required>
        ...
        function edit(id) {
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('#house_id_edit').val(dataEdit[0].id);
                    $('#house_name_edit').val(dataEdit[0].house_name);
                },
                error: function() {
                    alert('ไม่สามารถเพิ่มข้อมูลได้');
                }
